"""Native cognis-connect emit for forkfuzz — forward findings to any platform.

Maps forkfuzz's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    forkfuzz ... --format json | forkfuzz-emit --to stix
    forkfuzz-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
