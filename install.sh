#!/usr/bin/env sh
# Universal installer for forkfuzz. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/forkfuzz.git"
echo "Installing forkfuzz ..."
